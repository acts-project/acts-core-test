...
BOOST_FIXTURE_TEST_CASE(LayerCreator_createCylinderLayer, LayerCreatorFixture) {
  ...
  // CASE III
  ProtoLayer pl3;
  pl3.extent.ranges[binR].first = 1;
  pl3.extent.ranges[binR].second = 20;
  pl3.extent.ranges[binZ].first = -25;
  pl3.extent.ranges[binZ].second = 25;
  layer = std::dynamic_pointer_cast<CylinderLayer>(
...
BOOST_FIXTURE_TEST_CASE(LayerCreator_createDiscLayer, LayerCreatorFixture) {
  ...
  pl.extent.ranges[binZ].first = -10;
  pl.extent.ranges[binZ].second = 10;
  pl.extent.ranges[binR].first = 5;
  pl.extent.ranges[binR].second = 25;
