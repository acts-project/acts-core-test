/ BoundingBoxTest.cpp : 407  // This file is part of the Acts project.
//
...
#include "Acts/Utilities/Ray.hpp"
  ...
  BOOST_AUTO_TEST_CASE(box_construction) {
    ...
    BOOST_TEST_CONTEXT("3D") {
      ...
      CHECK_CLOSE_ABS(bb_rot2.min(), Vector3F(-2.40848, -1.51816, -2.0559),
                      1e-4);
    ...
    BOOST_TEST_CONTEXT("3D - 3 Sides") {
      ...
      fr_exp = {
          ...
          {Frustum3({0, 0, 0}, {0, 0, 1}, M_PI / 8.),
           {427, 428, 546, 547, 548, 549, 658, 659, 665, 666, 667, 668, 669,
            670, 680, 681, 780, 791, 802}},
        ...
        for (size_t i = 0; i <= n; i++) {
          for (size_t j = 0; j <= n; j++) {
            for (size_t k = 0; k <= n; k++) {
              ActsVectorF<3> pos(min + i * step, min + j * step,
                                 min + k * step);
              Box bb(&o, pos, size);
    ...
    BOOST_TEST_CONTEXT("3D - 4 Sides") {
      ...
      fr_exp = {
          ...
          {Frustum34({0, 0, 0}, {0, 0, 1}, M_PI / 4.),
           {406, 417, 428, 439, 450, 527, 535, 536, 537, 538, 546,
            547, 548, 549, 557, 558, 559, 560, 571, 648, 656, 657,
            658, 659, 665, 666, 667, 668, 669, 670, 678, 679, 680,
            681, 692, 769, 777, 778, 779, 780, 788, 789, 790, 791,
            799, 800, 801, 802, 813, 890, 901, 912, 923, 934}},
