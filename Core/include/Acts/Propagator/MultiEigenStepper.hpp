...
/// with targetSurface() method,
/// collect the candidate surfaces in Navigator
...
public:
  ...
  /// @copy similar method of the Single stepper
  /// @brief getField from single-component or multi-component
  /// @param [in,out] state is the propagation state associated with the track
  ///                 the magnetic field cell is used (and potentially updated)
  /// @param [in] pos is the field position
  /// @to do to remove this function and the fieldCache in MultiState
  ...
  void
  releaseComponents(State& state) const;
  ...
  /// this called in StandardAborter,
