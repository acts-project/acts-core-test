...
template <typename B, typename C, typename E, typename A>
  ...
  auto 
  Acts::EigenStepper<B, C, E, A>::buildState(State& state, bool reinitialize) const
  {	  
	  // The return type
...
template <typename B, typename C, typename E, typename A>
  ...
  auto 
  Acts::EigenStepper<B, C, E, A>::buildState(State& state, const Surface& surface, bool reinitialize) const {
